...
function CreditCard({ onClose, handleCreditCardButtonClick }) {
    ...
    }, [onClose, handleCreditCardButtonClick]); // onClose 또는 handleCreditCardButtonClick이 변경될 때마다 useEffect 재실행
